...
contract RUFFLE is ERC20, AdvancedTax {
    ...
    /// @notice Add liquidity to uniswap and mint the tokens
    /// @param tokens The number of tokens to mint when liquidity is added
    ...
    /// @dev mint happens on addLiquidity and during airdrop. Protected by multisig
    ...
    function _transfer(
        ...
        /*if (address(permission) != address(0)) {
            ...
            require(amount <= permission.buyLimit(recipient), "Buy limit exceeded");
        }*/
